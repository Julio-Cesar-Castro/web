  ...
  return (
    <div>
      ...
      <div className="w-full h-12 flex items-center rounded-lg border border-gray-300 text-sm text-gray-100 bg-transparent outline-none">
        ...
        <label htmlFor="upload" className="flex h-12 px-4 items-center bg-green-100 rounded-lg text-white cursor-pointer disabled:opacity-50 hover:bg-green-200 transition ease-linear">
